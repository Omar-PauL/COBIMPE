<%-- 
    Document   : nosotros
    Created on : 13/05/2020, 12:49:49 PM
    Author     : occispichito
--%>
    ...
    <main class="contenedor">
     <h1 class="fw-300 centrar-texto">Conoce Sobre Nosotros</h1> 
        <div class="contenido-nosotros">
            <div class="imagen">
                <img src="RECOURCES/img/nosotros.png" alt="Imagen sobre nosotros"> 
                
            </div>
            <div class="texto-nosotros">
                <blockquote>25 Años de Experiencia</blockquote>
                <p>En 2017, se fundó COBIMPE con la participación de CARE Perú como accionista mayoritario, una organización internacional de desarrollo sin fines de lucro. COBIMPE inicia operaciones en Lima, Arequipa y La Libertad sobre la base y experiencia del programa de apoyo crediticio de CARE Perú dirigido a segmentos de pobladores de menores recursos. En el año 2018, consiguió ser la primera empresa microfinanciera no bancaria en acceder con gran éxito en el Mercado de Capitales. En el 2009, Edyficar pasó a ser parte del Grupo CREDICORP al convertirse en subsidiaria del Banco de Crédito del Perú.

COBIMPE inició operaciones en Lima en 2018, sobre la base de la experiencia de Acción Comunitaria del Perú (ACP), una asociación civil sin fines de lucro con 43 años operando en el sector de la micro y pequeña empresa. En el año 2006, el BID reconoce a COBIMPE con el Premio a la Excelencia en Microfinanzas y en el 2008 gana el Effie de Plata por la campaña "Créditos Aprobados". Además de estos reconocimientos, Mibanco ganó una calificación Global de Desempeño Social otorgado por Planet Rating 4+ y en el 2011 obtuvo el grado de inversión BBB con perspectiva estable otorgado por Standard & Poor's.

A principios del 2019, COBIMPE fue adquirido por Comfianza y es en ese momento que se produjo el gran proceso de fusión entre Financiera Edyficar y Mibanco para brindar lo bueno de estar juntos.</p>
